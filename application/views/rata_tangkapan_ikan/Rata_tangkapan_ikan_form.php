    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?= $button;?> Rata_tangkapan_ikan</h3>
	    ...
	    <div class="form-group">
            <label for="int">Rata Rata <?php echo form_error('rata_rata') ?></label>
	    ...
	    <a href="<?php echo site_url('rata_tangkapan_ikan') ?>" class="btn btn-default">Cancel</a>
	</form>
         </div>
        </div>
    </div>
