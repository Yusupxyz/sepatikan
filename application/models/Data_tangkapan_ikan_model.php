...
class Data_tangkapan_ikan_model extends CI_Model
{

    public $table = 'data_tangkapan_ikan';
    public $id = 'id';
    public $order = 'DESC';
    ...
    {
        $this->db->select('*');
        $this->db->join('stasiun', 'data_tangkapan_ikan.id_stasiun=stasiun.id','left');
...
/* End of file Data_tangkapan_ikan_model.php */
/* Location: ./application/models/Data_tangkapan_ikan_model.php */
