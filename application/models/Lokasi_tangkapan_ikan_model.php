...
class Lokasi_tangkapan_ikan_model extends CI_Model
{

    public $table = 'lokasi_tangkapan_ikan';
    public $id = 'id';
    public $order = 'DESC';
    ...
    {
        $this->db->select('*');
        $this->db->join('stasiun', 'lokasi_tangkapan_ikan.id_stasiun=stasiun.id','left');
...
/* End of file Lokasi_tangkapan_ikan_model.php */
/* Location: ./application/models/Lokasi_tangkapan_ikan_model.php */
